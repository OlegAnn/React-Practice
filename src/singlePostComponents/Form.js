...
export default class Form extends Component{
    ...
    handleSubmit(event){
      ...
      this.props.getComment(this.state.name, this.state.email, this.state.body)
    }
    ...
    render(){
        return(
            <form onSubmit={this.handleSubmit} action="#" className="uk-comment-form uk-margin-medium-top">
